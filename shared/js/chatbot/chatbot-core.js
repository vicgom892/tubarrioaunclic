...
class TuBarrioChatbot {
    ...
    generateCategoryUrl(category) {
        ...
        return this.getCorrectUrl(`/${this.currentLocalidad}/categorias/${urlCategory}.html`);
    }
    ...
    parseBusinessHours(hoursString, currentTime) {
        ...
        for (const format of timeFormats) {
            ...
            if (timeMatch) {
                ...
                // Manejar horarios que pasas de medianoche
                if (endTime < startTime) {
                    endTime += 24 * 60;
                }
        ...
        try {
            ...
            if (relevantOficios.length === 0) {
                return `❌ No encontré ${oficioType ? oficioType + ' ' : ''}disponibles. ` +
                       `Puedes [ver todos los oficios aquí](${this.getCorrectUrl(`/${this.currentLocalidad}/oficios-profeciones.html`)})`;
            }
            ...
            return `🔧 No pude cargar la información de profesionales. ` +
                   `Puedes [ver los oficios disponibles aquí](${this.getCorrectUrl(`/${this.currentLocalidad}/oficios-profeciones.html`)})`;
        }
    }
        ...
        try {
            ...
            if (!ofertas || ofertas.length === 0) {
                ...
                return "📭 No hay ofertas disponibles en este momento. ¡Vuelve pronto para descubrir nuevas promociones!\n\n" +
                       `💡 *¿Eres un comercio? [Agrega tus ofertas aquí](${this.getCorrectUrl(`/${this.currentLocalidad}/inscripcion.html`)})*`;
            }
            ...
            return "❌ No pude cargar las ofertas en este momento. Por favor intenta más tarde.\n\n" +
                   `💡 *Puedes [ver las ofertas en la web](${this.getCorrectUrl(`/${this.currentLocalidad}/comunidad-de-ofertas.html`)})*`;
        }
    }
    ...
    createChatInterface() {
        const chatHTML = `
            <div id="tuBarrioChatbot" class="chatbot-container">
                <div class="chatbot-header">
                    <div class="chatbot-logo">
                        <img src="../shared/img/icon-abeja-sola.png" alt="Tu Barrio A Un Click">
            ...
            <button class="chatbot-toggle">
                <img src="../shared/img/icon-abeja-sola.png" alt="Chat Tu Barrio">
